...
{
    public class CommunicationUpdateRepo : Repository<CommunicationUpdates>, ICommunicationUpdateRepo
    {
        public CommunicationUpdateRepo(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
